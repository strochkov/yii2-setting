...
{
    public $controllerNamespace = 'strochkov\setting\controllers\frontend';
    ...
    public function init()
    {
        ...
        $this->setViewPath('@strochkov/setting/views');
    }
    ...
    {
        return Yii::t('strochkov/' . $category, $message, $params, $language);
    }
